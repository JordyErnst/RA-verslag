...
`Rsubread (V2.20.0)` en `Rsamtools (V2.22.0)` werden gebruikt om een menselijk refentiegenoom te indexeren. Op deze index werden de patienten sequenties gemapped. Hiermee werden reads van de patienten gekoppeld binnen aan locaties in het menselijkgenoom.
